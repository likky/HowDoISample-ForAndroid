...
namespace CSHowDoISamples
{
    ...
    public class AddATouchEventOnMap : SampleActivity
    {
        ...
        private void AndroidMap_MapSingleTap(object sender, MotionEvent e)
        {
            ...
            marker.SetImageBitmap(Android.Graphics.BitmapFactory.DecodeResource(ThinkGeo.MapSuite.Android.Resources, Resource.Drawable.Pin));
            marker.YOffset = -(int)(22 * ThinkGeo.MapSuite.Android.Resources.DisplayMetrics.Density);
