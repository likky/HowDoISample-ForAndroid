...
namespace CSHowDoISamples
{
    ...
    public class AddAMarker : SampleActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            thinkGeoLocation.SetImageBitmap(Android.Graphics.BitmapFactory.DecodeResource(ThinkGeo.MapSuite.Android.Resources, Resource.Drawable.Pin));
            thinkGeoLocation.YOffset = -(int)(22 * ThinkGeo.MapSuite.Android.Resources.DisplayMetrics.Density);
